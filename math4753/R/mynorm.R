#' course 4753
#'
#' make a contour plot based on the value of mu and variance.
#'
#' @param x  make a contour plot based on the value of mu and variance
#'
#' @return a contour plot which y = variance and x = mean
#'
#' @examples
#' mynorm(x = c(10,12,13,15,12,11,10),
